...
const App = () => {
  return (
    ...
    <div class="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      {/* <div class="h-screen py-8 overflow-y-auto bg-white border-l border-r sm:w-64 w-60 bg-gray-900 dark:bg-gray-900 dark:border-gray-700">
          <h2 class="px-5 text-lg font-medium text-gray-800 dark:text-white">Assets</h2>
