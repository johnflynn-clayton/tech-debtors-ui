...
const App = () => {
  return (
    ...
    <header aria-label="Page Header" class="bg-gray-50 bg-gray-900 text-gray-600 transition hover:text-gray-700 ">
    <div class="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div
            class="flex flex-1 items-center justify-between gap-8 sm:justify-end text-2xl font-bold text-gray-900 sm:text-3xl"
        >
            ...
            <img
                alt="Man"
                src="https://media.istockphoto.com/id/1308394354/photo/senior-man-using-tablet-to-talk-to-his-family.jpg?s=1024x1024&w=is&k=20&c=nbwYw8GZt3bwh8eZ9qfhPVhxZSC7Ocxceb4xtetDR_g="
                class="h-10 w-10 rounded-full object-cover"
            />

            <p class="ml-2 hidden text-left text-xs sm:block">
                <strong class="block font-medium">Frank Lassiter</strong>

                <span class="text-gray-500"> frank.lassiter@claytonhomes.com </span>
            </p>
        ...
        <div class="mt-8">
        <h1 class="text-2xl font-bold text-blue-50 sm:text-3xl">
            Welcome Back, Frank!
        </h1>

        <p class="mt-1.5 text-sm text-gray-500">
            Your asset tracker has seen a 85% decrease in theft in the last month. Keep
            it up! 🚀
        </p>
        </div>
    </div>
      ...
      <div class="flex flex-col items-center w-16 h-screen py-8 space-y-8  bg-gray-900 dark:bg-gray-900 dark:border-gray-700">
          <a href="#">
      ...
      <div className="mapContainer bg-gray-900 text-white py-6">
        <div className="container mx-0 px-2 bg-gray-900 flex">
          <MapContainer />
        </div>
      </div>
    </aside>
          ...
          <ul class="mt-8 space-y-4 text-sm">
            <li>
              ...
              >
                ...
                <span class="text-gray-700">frank.lassiter@claytonhomes.com</span>
              </a>
            </li>
            ...
            <li>
              ...
              >
                ...
                <span class="text-gray-700">5551112222</span>
              </a>
            </li>
